...
(!!!) import { MOD_COLOR, ADMIN_COLOR, PATREON_COLOR, ANNOUNCEMENT_COLOR, WHITE, --> SOME_TAG_COLOR }'./colors';
...
(!!!) '<tag-name>': { ...placeholder, name: '<some-text>', className: '<tag-class>', color: SOME_TAG_COLOR },
